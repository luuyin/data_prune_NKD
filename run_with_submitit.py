...
def parse_args():
    ...
    parser.add_argument("--timeout", default=1, type=int, help="Duration of the job, in hours")
    ...
    parser.add_argument('--node_list', nargs="*", type=str, default = None, help='kernel size of conv [stage1, stage2, stage3, stage4, N]')
    return parser.parse_args()


def get_shared_folder() -> Path:
    user = os.getenv("USER")
    if Path("/home/sliu/project_space/datasets/TJ_RobustData/SLaK/checkpoint/").is_dir():
        p = Path(f"/home/sliu/project_space/datasets/TJ_RobustData/SLaK/checkpoint/convnext")
